...
@php
    ...
    $breadcrumbs_array = [
                    ...
                    ['name' => $selected_article->{'title_' . $current_lang->code}, 'url' => request()->fullUrl()],
    ];
@endphp
            ...
            <div class="page_content_block flex_row">
                ...
                <div class="article_content_block flex_column">
                    ...
                    <div class="date_row flex_row">
                        ...
                        <span class="date">{{ date('d.m.Y', strtotime($selected_article->published_date)) }}</span>
                    </div>

                    <div class="text_block">
                        
                        <h3 class="text_title">{{ $selected_article->{'title_' . $current_lang->code} }}</h3>

                        {!! $selected_article->{'description_' . $current_lang->code} !!}
                    </div>
                </div>
            </div>
