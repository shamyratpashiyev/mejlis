            ...
            <div class="page_content_block flex_row">
                ...
                <div class="activity_content_block flex_column">
                    ...
                    <div class="date_row flex_row">
                        ...
                        <span class="date">{{ date('d.m.Y', strtotime($selected_activity->event_date)) }}</span>
                    </div>

                    <div class="text_block">
                        
                        <h3 class="text_title">{{ $selected_activity->{'title_' . $current_lang->code} }}</h3>

                        {!! $selected_activity->{'description_' . $current_lang->code} !!}
                    </div>
                </div>
            </div>
