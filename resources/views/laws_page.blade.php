...
@php
    $links_list = [
                    ...
                    ['name' => __('app.laws_page.title'), 'is_active'=>'active', 'url' => route('laws_page',['lang' => app()->getLocale()])],
...
@section('content')
            ...
            <div class="page_content_block flex_row">
                ...
                <div class="right_side flex_column">
                    ...
                    <div class="nav_buttons_row flex_row">
                        ...
                        <a href="{{ route('laws_page', ['lang' => app()->getLocale()]) }}" class="button_container active flex_column">
                            <svg width="92" height="92" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <mask id="path-1-inside-1_161_8853" fill="white">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M55.058 19.141L46 10.083L36.9419 19.141H24.4333V31.6497L15.5 40.583L24.4333 49.5163V62.2745H37.1915L46 71.083L54.8084 62.2745H67.5668V49.5162L76.5 40.583L67.5668 31.6498V19.141H55.058Z"/>
                                </mask>
                    ...
                    <div class="search_row flex_row">
                        ...
                        <input type="text" id="document_name_input" placeholder="{{ __('app.laws_page.document_name') }}"/>

                        <select id="choose_year_select">
                            <option value="--">@lang('app.laws_page.choose_year')</option>
                        ...
                        <select id="choose_month_select">
                            <option value="--">@lang('app.laws_page.choose_month')</option>
                            @lang('app.months')
                        </select>
                    </div>

                    <div class="items_block flex_row">
                        @foreach ($laws_current_page as $law)
                        ...
                        <div class="pagination_row flex_row">
                            <a class="flex_row" style="align-items: center;" href="{{ route('laws_page', ['page_num' => $prev_page, 'lang' => app()->getLocale()]) }}">
                            ...
                            @foreach ($pagination_array as $page)
                                ...
                                @else
                                    <a href="{{ route('laws_page', ['page_num' => $page, 'lang' => app()->getLocale()]) }}" class="item @if($current_page == $page) active @endif">{{ $page }}</a>
                                @endif
                            @endforeach

                            <a href="{{ route('laws_page', ['page_num' => $next_page, 'lang' => app()->getLocale()]) }}">
                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <script>
        $(document).ready(function (){
            const items_list_initial = JSON.parse(`{{ json_encode($laws_all) }}`.replaceAll('&quot;','"'))
