...
@php
    $links_list = [
                    ...
                    ['name'=>__('app.news_international_page.title'),'is_active'=>'active', 'url' => route('news_international_page',['lang' => app()->getLocale()])],
    ];
    $breadcrumbs_array = [
    ...
    <div class="news_international_page flex_row">
        <div class="inner_wrapper flex_column">
            ...
            <div class="page_content_block flex_row">
                ...
                <div class="right_side flex_column">
                    @foreach ($news_current_page as $news)
                        <a href="{{ route('single_news_international_page',['id'=>$news->id,'lang'=>app()->getLocale()]) }}" class="news_container flex_row">
            ...
            <div class="pagination_row flex_row">
                <a class="flex_row" style="align-items: center;" href="{{ route('news_international_page', ['page_num' => $prev_page, 'lang' => app()->getLocale()]) }}">
                ...
                @foreach ($pagination_array as $page)
                    ...
                    @else
                        <a href="{{ route('news_international_page', ['page_num' => $page, 'lang' => app()->getLocale()]) }}" class="item @if($current_page == $page) active @endif">{{ $page }}</a>
                    @endif
                @endforeach

                <a href="{{ route('news_international_page', ['page_num' => $next_page, 'lang' => app()->getLocale()]) }}">
                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
