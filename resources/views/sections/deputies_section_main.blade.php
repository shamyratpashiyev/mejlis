<div class="deputies_section flex_row">
    <div class="inner_wrapper">
        <h2 class="title">@lang('app.main.deputies_section')</h2>
        <div class="content_block flex_row">
            ...
            <div class="map_block flex_row">
                <div class="map_wrapper">
                    ...
                    <span class="region_name" data-region-id="dashoguz_region">@lang('app.main.dashoguz')</span>
            ...
            <div class="deputies_block_scroll flex_column">
                ...
                <div class="region_wrapper" data-region-name="ahal_region">
                    <h3 class="region_name">@lang('app.main.ahal_region')</h3>
                    <hr />
                ...
                <div class="region_wrapper" data-region-name="balkan_region">
                    <h3 class="region_name">@lang('app.main.balkan_region')</h3>
                    <hr />
                ...
                <div class="region_wrapper" data-region-name="dashoguz_region">
                    <h3 class="region_name">@lang('app.main.dashoguz_region')</h3>
                    <hr />
                ...
                <div class="region_wrapper" data-region-name="lebap_region">
                    <h3 class="region_name">@lang('app.main.lebap_region')</h3>
                    <hr />
                ...
                <div class="region_wrapper" data-region-name="mary_region">
                    <h3 class="region_name">@lang('app.main.mary_region')</h3>
                    <hr />
