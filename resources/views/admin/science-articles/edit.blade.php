...
<div class="content">
    ...
    <div class="title">
        <h1 class="title">Изменение научной статьи</h1>
    </div>

    <form action="{{route('admin.science-article.update', $article)}}" method="post" class="edit__form" enctype="multipart/form-data">
        @csrf
        @method('patch')
        <!-- ROW  -->
        <div class="row">
            ...
            <div class="form__item w30">
                ...
                <input type="text" class="inputTxt" name="tm_title" value="{{$article->tm_title}}">
                @error("tm_title")
            ...
            <div class="form__item w30">
                ...
                <input type="text" class="inputTxt" name="ru_title" value="{{$article->ru_title}}">
                @error("ru_title")
                <p class="err">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="form__item w30">
                ...
                <input type="text" class="inputTxt" name="en_title" value="{{$article->en_title}}">
                @error("en_title")
                <p class="err">{{$message}}</p>
                @enderror
            </div>
        ...
        <div class="row">
            ...
            <div class="form__item w30">
                ...
                <input type="text" class="inputTxt" name="tm_author" value="{{$article->tm_author}}">
                @error("tm_author")
                <p class="err">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="form__item w30">
                ...
                <input type="text" class="inputTxt" name="ru_author" value="{{$article->ru_author}}">
                @error("ru_author")
                <p class="err">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="form__item w30">
                ...
                <input type="text" class="inputTxt" name="en_author" value="{{$article->en_author}}">
                @error("en_author")
                <p class="err">{{$message}}</p>
                @enderror
            </div>
        ...
        <div class="row">
            ...
            <div class="form__item w45">
                ...
                <textarea id="editor-13" name="tm_content">{{$article->tm_content}}</textarea>
                @error("tm_content")
                <p class="err">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="form__item w45">
                ...
                <textarea id="editor-14" name="ru_content">{{$article->tm_content}}</textarea>
                @error("ru_content")
                <p class="err">{{$message}}</p>
                @enderror
            </div>
        ...
        <div class="row">
            ...
            <div class="form__item w45">
                ...
                <textarea id="editor-15" name="en_content">{{$article->tm_content}}</textarea>
                @error("en_content")
                <p class="err">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="form__item w45">
                <div class="column">
                    ...
                    <div class="form__item w60">
                        ...
                        <div class="form__select__box">
                            <select name="category_id" id="categories" class="form-control">
                                ...
                                <option {{$cat->id === $article->category->id ? 'selected' : ''}} value="{{$cat->id}}">{{$cat->ru_title}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form__item w60">
                        ...
                        <div class="form__select__box">
                            <select name="subCategory_id" id="sub" class="form-control">
                                ...
                                <option @if($article->subCategory) {{$article->subCategory->id == $sc->id ? 'selected' : ""}} @endif value="{{$sc->id}}">{{$sc->ru_title}}</option>
                                @endforeach
                    ...
                    <div class="form__item w40">
                        ...
                        <input type="datetime-local" class="inputDate" name="date" value="{{$article->date}}">
                        @error("date")
                        <p class="err">{{$message}}</p>
                        @enderror
                    </div>
