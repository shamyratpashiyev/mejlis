...
<div class="content">
    <div class="title">
        <h1 class="title">Международные новости</h1>


        <a href="{{ route('news_inter.create') }}">
            Добавить
        </a>
        ...
        @foreach($news_all as $news )
            ...
            <div class="list__item">
                ...
                <div class="item__button w5a5">
                    <a href="{{ route('news_inter.edit', $news->id) }}">
                        <img src="{{ asset('admins/img/ico/edit_v2.svg') }}">
                    </a>

                    <form action="{{ route('news_inter.destroy', $news->id) }}" method="POST">
                        @csrf
                        @method('delete')
                        <label for="{{ $news->id }}">
