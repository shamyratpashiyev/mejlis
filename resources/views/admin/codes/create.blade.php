...
<div class="content">
    ...
    <div class="title">
        <h1 class="title">Добавление Кодекса</h1>
    </div>

    <form action="{{ route('codes.store') }}" method="POST" class="edit__form" enctype="multipart/form-data">
        @csrf
        <!-- ROW  -->
        <div class="row">
            <!-- form__item -->
        ...
        <div class="row">
            ...
            <div class="form__item w15">
                ...
                <input type="date" class="inputDate" name="published_date">
                @error('event_date')
                    <p class="err">{{ $message }}</p>
                @enderror
            </div>
