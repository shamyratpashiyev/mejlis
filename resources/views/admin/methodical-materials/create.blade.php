...
<div class="crumbs">
    ...
    <img src="{{ asset('admins/img/ico/arrow.svg') }}">
    <div>
        Добавление Методических материалов
    </div>
...
<div class="content">
    ...
    <div class="title">
        <h1 class="title">Добавление Методических материалов</h1>
    </div>

    <form action="{{route('admin.metodical-material.store')}}" method="post" class="edit__form" enctype="multipart/form-data">
        @csrf
        <!-- ROW  -->
        <div class="row">
            <!-- form__item -->
