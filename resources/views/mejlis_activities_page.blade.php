...
@php
    $links_list = [
                    ...
                    ['name'=>__('app.mejlis_activities_page.title'),'is_active'=>'active', 'url' => route('mejlis_activities_page',['lang' => app()->getLocale()])],
    ...
    $breadcrumbs_array = [
                    ...
                    ['name' => __('app.layout.mejlis_activities_page'), 'url' => request()->fullUrl()],
    ];
@endphp
    ...
    <div class="mejlis_activities_page flex_row">
        <div class="inner_wrapper flex_column">
            ...
            <div class="page_content_block flex_row">
                ...
                <div class="activities_block">
                    ...
                    <div class="activities_row flex_row">
                        @foreach ($activities_current_page as $activity)
            ...
            <div class="pagination_row flex_row">
                <a class="flex_row" style="align-items: center;" href="{{ route('mejlis_activities_page', ['page_num' => $prev_page, 'lang' => app()->getLocale()]) }}">
                ...
                @foreach ($pagination_array as $page)
                    ...
                    @else
                        <a href="{{ route('mejlis_activities_page', ['page_num' => $page, 'lang' => app()->getLocale()]) }}" class="item @if($current_page == $page) active @endif">{{ $page }}</a>
                    @endif
                @endforeach

                <a href="{{ route('mejlis_activities_page', ['page_num' => $next_page, 'lang' => app()->getLocale()]) }}">
                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
