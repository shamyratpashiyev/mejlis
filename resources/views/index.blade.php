...
<div class="sections_container">
        ...
        <div class="inner_wrapper flex_column">
            ...
            <div class="grid_block">
                ...
                <a href="{{ route('single_news_page', ['lang'=>app()->getLocale(),'id'=>$news_big['id']]) }}" class="news_container_big flex_column">
                    ...
                    <h3 class="title">{{ $news_big['title_' . $current_lang->name] }}</h3>
                    <p  class="content">
                        {{ $news_big['description_' . $current_lang->name] }}
                    </p>
            ...
            <div class="activities_row flex_row">
                @foreach ($mejlis_activities as $activity)
                    <div class="activity_container flex_column container_box_shadow" data-href-value="#">
                        ...
                        <h3 class="title">{{ $activity->{'title_' . $current_lang->name} }}</h3>
                        <div class="content">
                            {!! $activity->{'description_' . $current_lang->name} !!}
                        </div>
    ...
    <div class="legislation_section flex_row">
        <div class="inner_wrapper">
            <h2 class="title">@lang('app.main.legislation_section')</h2>
