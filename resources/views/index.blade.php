    ...
    <div class="inner_wrapper">
        <div class="title_row flex_row">
            ...
            <div class="buttons_block">
                <svg class="arrow_left" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg class="arrow_right" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="content_block flex_row">
            ...
            <div class="website_container flex_column">
...
$(window).on('scroll',(event)=> {
    ...
    if($(window).scrollTop() > 10) {
        $('header .upper_block').addClass('active')

    } else if($(window).scrollTop() == 0){
        $('header .upper_block').removeClass('active')
    }
});
